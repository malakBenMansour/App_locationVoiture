...
@Component({
  selector: 'app-categorie-front',
  templateUrl: './categorie-front.component.html',
  styleUrls: ['./categorie-front.component.scss']
})
export class CategorieFrontComponent implements OnInit {
