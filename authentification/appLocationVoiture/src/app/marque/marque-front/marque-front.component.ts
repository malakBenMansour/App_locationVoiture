...
@Component({
  selector: 'app-marque-front',
  templateUrl: './marque-front.component.html',
  styleUrls: ['./marque-front.component.scss']
})
export class MarqueFrontComponent implements OnInit {
