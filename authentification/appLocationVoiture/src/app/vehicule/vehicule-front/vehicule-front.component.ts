...
@Component({
  selector: 'app-vehicule-front',
  templateUrl: './vehicule-front.component.html',
  styleUrls: ['./vehicule-front.component.scss']
})
export class VehiculeFrontComponent implements OnInit {
