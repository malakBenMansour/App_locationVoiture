 ...
 */
    ...
    public ResponseEntity<Categorie> updateCategorie(@PathVariable int id, @RequestBody Categorie employeeDetails) {
        Categorie employee = categorieService.findById(id);
        employee.setNom(employeeDetails.getNom());

        Categorie updateBoite = categorieService.update(employee);
