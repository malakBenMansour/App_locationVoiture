...
*/
    ...
    public ResponseEntity<Marque> updateMarque(@PathVariable int id, @RequestBody Marque employeeDetails) {
        Marque employee = $marqueService.findById(id);
        employee.setNom(employeeDetails.getNom());

        Marque updateBoite = $marqueService.update(employee);
